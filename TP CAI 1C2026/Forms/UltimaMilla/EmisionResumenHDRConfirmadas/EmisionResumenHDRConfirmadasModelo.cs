...
namespace TP_CAI_1C2026.Forms.UltimaMilla.EmisionResumenHDRConfirmadas
{
        ...
        private List<HDREnTransito> hdrs = new List<HDREnTransito>
    {
        ...
        new HDREnTransito  { NroHDR = "1003" , Domicilio = "Florida 222 - CABA" , CantEcomiendas = "2", DniFletero = 87654321, Estado = "En Tránsito" },
        ...
        new HDREnTransito  { NroHDR = "1007" , Domicilio = "Mitre 600 - CABA" , CantEcomiendas = "2", DniFletero = 99999999, Estado = "En Tránsito" },
        new HDREnTransito  { NroHDR = "1005" , Domicilio = "Peron 100 - CABA" , CantEcomiendas = "1", DniFletero = 99999999, Estado = "En Tránsito" },
        new HDREnTransito  { NroHDR = "1008" , Domicilio = "Callao 500 - CABA" , CantEcomiendas = "5", DniFletero = 12345678, Estado = "Confirmada" },
        new HDREnTransito  { NroHDR = "1009" , Domicilio = "Junin 1200 - CABA" , CantEcomiendas = "6", DniFletero = 11223344, Estado = "Confirmada" }
    };
