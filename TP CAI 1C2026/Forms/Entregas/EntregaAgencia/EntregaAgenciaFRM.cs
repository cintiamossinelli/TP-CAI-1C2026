...
{
    public partial class EntregaAgenciaFRM : Form
    {
        private readonly EntregaAgenciaModelo modelo = new EntregaAgenciaModelo();

        public EntregaAgenciaFRM()
        {
            InitializeComponent();
        }

        private void EntregaAgenciaFRM_Load_1(object sender, EventArgs e)
        {
